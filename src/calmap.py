...
def yearplot(
    ...
    **kwargs
    ...
    # PATCH: DataFrame.pivot is keyword only
    ...
    # PATCH: this seems to ignore monthlabels/monthticks
...
def calendarplot(
    ...
    fig_kws=None,
    fig_suptitle=None,
    # PATCH: this is overwritten, preventing vmin and vmax from entering kwargs
    # but they are unused in the function, so they have no effect anymore
    # vmin=None,
    # vmax=None,
    **kwargs
):
